...
for (var i = 0; i < localStorage.length; i++)  
  ...
  落叶消失在旧日的风中，唯有那盈盈的微笑篆刻在岁月的年轮上······ 
				...
				<textarea id="demo1" cols="90" rows="6" style="background-color:#D0E9C6; margin-left: 200px;" ></textarea><br/><br/>  
				<div class="col-md-10 col-md-offset-6">
				<input type="button" class="btn btn-info"  value="发表" onclick="saveStorage('demo1');" />   
				<input type="button" class="btn btn-danger" value="清空" onclick="clearStorage('msg1');" />   
				<input type="button" class="btn btn-success" value="读取" onclick="loadStorage('msg1');" />
				</div>
				<hr color="red" >  
				<p id="msg1"></p>  
			</div>
